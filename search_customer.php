    ...
    if (isset($_GET['search'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                //$booking_query = "SELECT COUNT(*) AS total_paid FROM payments WHERE bookings.customer_id='$customer_id' AND bookings.payment_id=payments.id AND payments.payment_status='verified'";
