...
function getCountryByIP() {
    ...
    if ($response) {
        ...
        return $data['country_name'] ?? 'Malaysia';
    }
...
<div class="max-w-2xl mx-auto mt-10 bg-white p-8 rounded-xl shadow-md">
    ...
    <?php if ($submitted): ?>
        ...
        <p class="text-gray-700 text-center">Thank you for submitting your Malaysia visa documents.</p>
    ...
    <?php else: ?>
        <h2 class="text-2xl font-bold text-blue-600 text-center mb-6">Upload Documents fo Malaysia Visa</h2>
